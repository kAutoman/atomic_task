                ...
                <Stack mt="3" borderRadius={16}>
                        ...
                        <View style={{padding:15,height:100}}> 
                            ...
                            <View style={{marginTop:50,marginLeft:20,display:"flex",flexWrap:"wrap",alignItems:"center"}}>
                                <Text color="white" w="40%" fontSize="43px" textAlign="left" bold>200 catd</Text>    
                                <TouchableOpacity>
                                    <Button size="sm" ml={30} w={180} h={60} alignSelf="center" borderRadius={16} onPress={()=>{setModalStatus(true)}}  variant="solid" backgroundColor="black">
